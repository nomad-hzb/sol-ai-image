![docker image](https://github.com/nomad-hzb/nomad-distro-template/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/nomad-distro-template.git
    ...
    ```sh
    curl-L -o nomad-distro-template.zip "https://github.com/nomad-hzb/nomad-distro-template/archive/main.zip"
...
```sh
git remote add template https://github.com/nomad-hzb/nomad-distro-template
git fetch template
...
For detailed instructions on how to resolve the merge conflicts between different version we refer you to the latest template release [notes](https://github.com/nomad-hzb/nomad-distro-template/releases/latest)
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/nomad-distro-template/manifests/main": unauthorized`
