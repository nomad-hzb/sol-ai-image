![docker image](https://github.com/nomad-hzb/sol-ai-image/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/sol-ai-image.git
    cd sol-ai-image
    ```
    ...
    ```sh
    curl-L -o sol-ai-image.zip "https://github.com/nomad-hzb/sol-ai-image/archive/main.zip"
    unzip sol-ai-image.zip
    cd sol-ai-image
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/sol-ai-image:main` for the services
...
```sh
docker pull ghcr.io/nomad-hzb/sol-ai-image/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/sol-ai-image/manifests/main": unauthorized`
